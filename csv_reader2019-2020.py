...
path = '/Users/hsiehyuanlung/Desktop/氣象資料/2020 自動/2020All'
...
for file in allFileList:
    if not file.startswith('.DS_Store') and os.path.join(path,file):    #不讀取'.DS_Store' 檔案
        ...
        print('Date : ' + file[5:13] + '    ' + str(mean_data))
        DailyTempMean[file[5:13]] = mean_data    #將資料儲存在DailyTempMean中
...
#WeeklyTempMeanDataFrame.to_csv('自動2019WeeklyTemp.csv') #輸出週均溫資料，可用 index = False 不輸出索引

...
#讀取單一檔案
data = pd.read_csv('/Users/hsiehyuanlung/Desktop/氣象資料/1998-2018局屬/1998-2017局屬.csv')#讀取資料
#print(data)
data = data[data['# stno'].astype(str).str.contains('466920')]  #篩選測站id
...
#WeeklyTempMeanDataFrame.to_csv('局屬1998-2017WeeklyTemp.csv') #輸出週均溫資料，可用 index = False 不輸出索引
